...
export default class Login extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      secureText: true,
      eyeIcon: 'eye-off',
      userType: 'customer', // Initialize the userType state
    };
  }
          ...
          <View style={{paddingHorizontal: SIZES.five}}>
            <View>
              <View
                ...
                <TouchableOpacity
                  onPress={this.handleCustomerPress}
                  activeOpacity={0.7}
                  style={[
                    styles.btn,
                  ...
                  <Text style={[FONTS.mediumFont14]}>Customer</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={this.handleVendorPress}
                  activeOpacity={0.7}
                  style={[
                    styles.btn,
                  ...
                  <Text style={[FONTS.mediumFont14]}>Vendor</Text>
                </TouchableOpacity>
              </View>

              <View
                style={[styles.textInputContainer, {marginTop: SIZES.twenty}]}>
                <EditText
                  ref={'email'}
